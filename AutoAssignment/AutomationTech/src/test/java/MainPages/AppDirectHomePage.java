...
{	
	...
	public AppDirectHomePage(WebDriver driver) throws IOException, FileNotFound 
	{
	 ...
	 public HomePageChecker verifyHomePageTitle() throws IOException 
	 {
		 return new HomePageChecker(this.driver);
	 }
		 
	public AppDirectLoginPage loginButtonClick() throws IOException {
		 driver.findElement(By.xpath(properties.getProperty("HomePageLoginButton"))).click(); 
